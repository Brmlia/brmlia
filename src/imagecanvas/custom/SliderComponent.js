...
class SliderComponent extends React.Component {
  ...
  updateBrightness() {
    if (this.api.getState().uniforms.brightness) {
      if (
        this.state.slider.brightness !==
        this.api.getState().uniforms.brightness.value
      ) {
  ...
  updateContrast() {
    if (this.api.getState().uniforms.contrast) {
      if (
        this.state.slider.contrast !==
        this.api.getState().uniforms.contrast.value
      ) {
        this.api.setState(prevState => ({
          uniforms: {
            ...prevState.uniforms,
  ...
  updateWhitepoint() {
    if (this.api.getState().uniforms.whitepoint) {
      if (
        this.state.slider.whitepoint !==
        this.api.getState().uniforms.whitepoint.value
      ) {
        this.api.setState(prevState => ({
          uniforms: {
            ...prevState.uniforms,
  ...
  updateBlackpoint() {
    if (this.api.getState().uniforms.blackpoint) {
      if (
        this.state.slider.blackpoint !==
        this.api.getState().uniforms.blackpoint.value
      ) {
        this.api.setState(prevState => ({
          uniforms: {
            ...prevState.uniforms,
