...
import {
  ...
  undo,
  redo,
} from '../annotations/fabric/editControl.js';
import {
  addAnnotation,
  addCachedAnnotation,
} from '../annotations/fabric/annotationControl.js';
...
class FabricLayer extends React.Component {
  ...
  setNewCoordinates(options) {
    ...
    this.setState({
      mousex:
        x < canvasLeft ? canvasLeft : x > canvasRight ? canvasRight - 15 : x,
      mousey:
        y < canvasTop ? canvasTop : y > canvasBottom ? canvasBottom - 15 : y,
    });
  }
  ...
  render() {
    return (
      <div id="annotationLayer">
        <canvas ref={this.canvasRef} width={750} height={750} />
