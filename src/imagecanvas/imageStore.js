...
export const createTextureFromTiff = image => {
  ...
  Promise.resolve(canv).then(
    function(canv) {
      console.log(
        'ImageStore::createTextureFromTiff() - Uint8Array with RGBA pixel length: ' +
          canv.byteLength
      );
      ...
      console.log(
        'ImageStore::createTextureFromTiff() - createTextureFromTiff() - texture ',
        texture
      );
      return texture;
    },
