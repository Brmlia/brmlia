...
class Viewer extends Component {
  ...
  state = {
    image: this.props.api.getState().file[this.props.api.getState().selected].image,
    zoom: 0
  }
  ...
  render() {
    ...
    useZoomApi.subscribe(state =>  {
      ...
      if (((this.state.zoom !== zoom) || (this.state.zoom !== zppZoom)) && (this.props.type === state.last)) {
    ...
    return (
      <div className="viewer-wrapper">
        <Zpp type={this.props.type} img={this.state.image} imageWidth={this.props.imageWidth}/>
